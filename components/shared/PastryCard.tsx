...
interface PastryCardProps {
  ...
  onToggleFavorite: (e: React.MouseEvent, type: 'pastry', item: Pastry) => void;
  isFavorited: boolean;
  ...
  return (
    ...
    >
        ...
        <div className="relative w-2/5 overflow-hidden">
          ...
          <div className="absolute top-2 right-2 bg-white/90 backdrop-blur-sm rounded-full p-1">
            <Button
              ...
              onClick={(e) => onToggleFavorite(e, 'pastry', pastry)}
            >
              <Star 
                className={`h-3 w-3 ${
                  isFavorited 
              ...
              <div className="space-y-1">
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  {pastry.removableIngredients.length > 2 && (
                    <Badge variant="secondary" className="text-xs px-1 py-0">+{pastry.removableIngredients.length - 2}</Badge>
                  )}
                </div>
              </div>
            )}
      ...
      <div className="hidden sm:block">
        ...
        <div className="p-4">
          <div className="space-y-2">
            <h3 className="text-lg font-bold text-primary">{pastry.name}</h3>
